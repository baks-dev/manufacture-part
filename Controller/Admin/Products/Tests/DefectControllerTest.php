...
#[When(env: 'test')]
final class DefectControllerTest extends WebTestCase
{
    private const URL = '/admin/manufacture/part/product/defect/%s';

    private const ROLE = 'ROLE_MANUFACTURE_PART_DEFECT';


    private static ?ManufacturePartProductUid $identifier;
